...
using PharmacyProject.Server.ViewModels.AccountViewModels;
using System.Security.Claims;
using PharmacyProject.Server.Extensions;
using PharmacyProject.Server.ViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                return RedirectToAction("Index", "Home", new ExternalLoginConfirmationViewModel { Email = email });
